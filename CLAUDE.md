...
- 下一步候选：M8 光照衰减 / 颜色高亮 / 噪音系统

## 七件套索引（只放指针）
- ① 本文档（根索引）
- ② 工单：`docs/工单/T-001-格子与移动.md` … `docs/工单/T-007-怪物视野与潜行.md`
- ③ 接力：`docs/接力/HANDOFF-T001.md`（含 commit + 下一步；**全程只有这一根棒**，勿按里程碑新建）
- ④ ADR：`docs/adr/ADR-001-技术选型.md`、`docs/adr/ADR-002-视野与渲染层.md`、`docs/adr/ADR-003-怪物感知与潜行.md`
- ⑤ 不变量（红线）：`docs/不变量.md`
- ⑥ 术语表：`docs/术语表.md`
- ⑦ 地图：`docs/地图.md`
