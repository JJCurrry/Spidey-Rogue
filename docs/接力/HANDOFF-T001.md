...
1. 读 `CLAUDE.md` → （T-018 已建，见 `docs/工单/T-018-怪物感知改用环境场.md` / `docs/adr/ADR-014-怪物感知改用环境场.md`）。下一步候选（接 M18，剩余两条，均来自 HANDOFF 后续项登记）：
