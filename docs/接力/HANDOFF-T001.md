...
1. 读 `CLAUDE.md` → （T-019 已建，见 `docs/工单/T-019-灯开关独立实体.md` / `docs/adr/ADR-015-灯开关独立实体.md`）。下一步候选（接 M19，剩余一条，来自 HANDOFF 后续项登记）：
